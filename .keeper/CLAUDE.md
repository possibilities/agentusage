...
Files in this tree (`epics/`, `specs/`, `tasks/`, `state/`) are **historical keeper state** — past plans, past task specs, past epic specs, runtime status. None of it describes work the human currently wants to plan.
