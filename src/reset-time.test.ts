...
// Mirrors the pinned `NOW` in test_parse_claude_usage.py: noon on 2026-05-29 in
// New York. May is EDT (-04:00) year-round-stable, so reprojected offsets are
// deterministic. Expected strings below are hand-computed, not re-derived.
const CLAUDE_NOW = Temporal.ZonedDateTime.from(
  "2026-05-29T12:00[America/New_York]",
);
// Mirrors test_parse_codex_status.py's pinned NOW (2026-05-15 12:00, -04:00).
...
describe("to24h — 12h to 24h, mirroring _to_24h", () => {
