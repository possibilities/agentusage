...
// Mirrors test_parse_claude_usage.py's pinned NOW (2026-05-29 12:00 in New
// York). Reset times reproject to `now`'s zone, so pinning a real IANA zone
// makes the expected offsets deterministic. Expected strings below are
// hand-computed off the Python fixtures, not re-derived by the parser.
